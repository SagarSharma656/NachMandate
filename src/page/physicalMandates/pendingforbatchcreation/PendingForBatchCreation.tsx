...
import { Order, PendingForBatchCreationData } from "../../../utils/types";
import { getComparator, stableSort } from "../../../utils/tablefunction";
import { EnhancedTableHead, EnhancedTableToolbar, rows } from "./PendingForBatchCreationHead";


export default function ApprovedMandates() {

  const [order, setOrder] = React.useState<Order>('asc');
  const [orderBy, setOrderBy] = React.useState<keyof PendingForBatchCreationData>('mandateId');
  ...
  const handleRequestSort = (
    ...
    property: keyof PendingForBatchCreationData,
  ) => {
