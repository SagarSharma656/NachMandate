  ...
  const linksNameArr = [
    ...
    },
    {
      ...
      sublinks: [
        ...
        "Rejected Aadhaar Mandates",
      ],
    },
    {
      link: "Mandate Analysis",
      sublinks: [
        "Physical Mandate Analysis",
        "E Mandate Analysis",
        "Aadhaar Mandate Analysis",
      ],
    },
    {
      link: "All UMRN",
    ...
    {
      link: "Debit Presentations",
      sublinks: [
        "All Debit Presentations",
        "Unapproved Presentations",
        "Approved Presentations",
        "Created Presentment Batches",
      ],
    },
    {
      link: "Scheduled Presentations",
      sublinks: [
    ...
    {
      link: "Data Entry Operations",
      sublinks: ["NACH Data Entry", "Initial Rejected Images"],
    },
    ...
    {
      link: "Pending UMRN & Response",
      sublinks: ["Pending UMRN And Response"],
    },
    {
      link: "UPI Mandate",
      sublinks: [
        ...
        "UPI Mandate Analysis",
      ],
    },
    {
      link: "UPI Presentation",
      sublinks: [
        "UPI Presentation",
        "UPI Unapproved Presentation",
        "UPI Pending for execution",
      ],
    },
    {
      link: "UPI Bulk",
      sublinks: ["UPI Bulk Mandate Creation", "Bulk UPI Verification"],
    },
  ];
  ...
  return (
    <Box>
      <Drawer variant="permanent" open={open}>
        <DrawerHeader style={{ minHeight: "35px" }}>
          <IconButton
